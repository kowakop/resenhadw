        ...
        if ($tipo == "admin") {
            ...
            <div>
                <div>
                    ...
                    <div class='texto_menu'>ADMIN</div>
                </div>
            </div>


            <a href='./obra/cadastrar.php' class='link_menu'>
                <div>
                    <div>cadastrar obras</div>
                </div>
            </a>

            <a href='./autor/cadastrar.php' class='link_menu'>
                <div>
                    <div>cadastrar autores</div>
                </div>
            </a>";
